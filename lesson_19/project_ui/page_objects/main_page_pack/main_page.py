from lesson_19.project_ui.page_objects.main_page_pack.main_page_locators import MainPageLocators
from lesson_19.project_ui.page_objects.players_page_pack.players_page import PlayersPage
