...
class MatchesPage(BasePage):
    ...
    def create_match(self):
        ...
        self.send_my_team_name().send_enemy_team_name().send_my_team_score().send_enemy_team_score().send_match_date()
